...
const API_URL = "http://localhost:3000/api/footer";
...
        // 🔹 FIX: socialLinks ko normalize karein.
        // Yeh API se 'icon' ya 'name' kuch bhi aaye, use 'name' mein badal dega jo aapka modal expect karta hai.
...
        // 🔹 FIX: contactInfo ko merge karein taaki koi field missing na ho
...
  const handleSave = () => {
    setError("");
    // 🔹 FIX: Ab socialLinks hamesha { name: "...", link: "..." } format mein save honge
